<?php
// Concede el permiso 'users.create' al rol admin/super_admin para permitir crear usuarios
...
try {
    ...
    if (!$permRow) { throw new Exception("Permiso users.create no disponible"); }
    $pid = (int)$permRow['id'];
    ...
    echo "✓ Permiso 'users.create' concedido al rol {$roleId}\n";
} catch (Exception $e) {
