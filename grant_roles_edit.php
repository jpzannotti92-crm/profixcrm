<?php
// Concede el permiso 'roles.edit' al rol admin/super_admin para permitir actualizar roles
...
try {
    ...
    if (!$permRow) { throw new Exception("Permiso roles.edit no disponible"); }
    $pid = (int)$permRow['id'];
    ...
    echo "✓ Permiso 'roles.edit' concedido al rol {$roleId}\n";
} catch (Exception $e) {
